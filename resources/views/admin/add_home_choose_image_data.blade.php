 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               <a href=""><span>Update Why Choose Us</span></a>
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            ...
            <h4 class="mb-4">Update Why Choose Us</h4>

         </div>
         <form action="{{url('admin/store_add_home_choose_image_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
