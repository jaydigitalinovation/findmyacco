...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Notch</span></a>
               @else
               <a href=""><span>Update Notch</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Notch</h4>
          @else
            <h4 class="mb-4">Update Notch</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_home_notch_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
