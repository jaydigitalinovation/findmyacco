      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
            	...
            	@foreach($education_choose_des as $id)
                 ...
                 <tr>
                  ...
                  <tr>
                  	 ...
                  	 <th><button class="clo btn0"><a href="{{url('admin/add_education_choose_des_data')}}/{{$id->id}}">update</a></button></th>  
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_education_choose_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($education_choose as $key=>$ad)
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_education_choose_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                  ...
                  .then((willDelete) => {
                    ...
                    var id = $id;
                          ...
                          $.ajax({
                                ...
                                url:BASE_URL+'/admin/delete_education_choose/'+id,
                                type:'GET',
                                dataType: "json",
