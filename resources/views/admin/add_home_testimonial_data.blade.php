 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               @if($id==0)
               <a href=""><span>Add Home Testimonials</span></a>
               @else
               <a href=""><span>Update Home Testimonials</span></a>
               @endif
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
             ...
             @if($id==0)
            <h4 class="mb-4">Add Home Testimonials</h4>
            @else
            <h4 class="mb-4">Update Home Testimonials</h4>
            @endif
