      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
            	...
            	@foreach($partner_info_des as $id)
                 ...
                 <tr>
                  ...
                  <tr>
                  	 ...
                  	 <th><button class="clo btn0"><a href="{{url('admin/add_partner_info_des_data')}}/{{$id->id}}">update</a></button></th>  
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_partner_info_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($partner_info as $key=>$ad)
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                        ...
                        <td>{{$ad->advantage}}</td>
                        <td>
                          <a class="icon__1" href="{{url('admin/add_partner_info_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
