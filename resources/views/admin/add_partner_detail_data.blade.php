...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Partner Detail</span></a>
               @else
               <a href=""><span>Update Partner Detail</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Partner Detail</h4>
          @else
            <h4 class="mb-4">Update Partner Detail</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_partner_detail_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
