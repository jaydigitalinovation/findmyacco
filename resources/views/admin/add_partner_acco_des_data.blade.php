 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               <a href=""><span>Update Accommodation Detail</span></a>
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            ...
            <h4 class="mb-4">Update Accommodation Detail</h4>

         </div>
         <form action="{{url('admin/store_add_partner_acco_des_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
