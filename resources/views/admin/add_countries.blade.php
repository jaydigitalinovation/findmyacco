 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               <a href=""><span>Add Contries</span></a>
               @else

                   <a href=""><span>Update Contries</span></a>
               @endif
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
              ...
              @if($id==0)
                ...
                <h4 class="mb-4">Add new Country</h4>
               @else
         ...
         <form action="{{url('admin/store_new_country')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
