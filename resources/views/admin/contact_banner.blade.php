...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Contact Banner Detail</span></a>
            </li>
         </ul>
      </div>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                     ...
                     <th><button class="clo btn0"><a href="{{url('admin/add_contact_detail_data')}}/{{$id->id}}">update</a></button></th>  
