...
@section('content')
 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <form action="{{url('admin/store_update_inner_banner_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
         <div class="detail table-responsive">
            <div class="details_main">
               ...
               <input type="hidden" placeholder="Enter page_name" name="name" value="{{$name}}" >
