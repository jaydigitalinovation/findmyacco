...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add new Timeline</span></a>
               @else
               <a href=""><span>Update Timeline</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add new Timeline</h4>
          @else
              <h4 class="mb-4">Update Timeline</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_aboutus_timeline_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
                  ...
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                           <input type="number" placeholder="Enter year" name="year" value="{{$year}}" >
