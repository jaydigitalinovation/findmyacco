 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               <a href=""><span>Update Scholarship Detail</span></a>
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            ...
            <h4 class="mb-4">Update Scholarship Detail</h4>

         </div>
         <form action="{{url('admin/store_add_scholarship_banner_title_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
