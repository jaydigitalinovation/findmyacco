...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Home Chooses Detail</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($home_choose_image as $id)
                 ...
                 <tr>
                    <th><div class="set_width"><img src="/uploads/{{$id->image2}}" class="w-100"></div></th>
                 </tr>


                  <tr>
                     <th><button class="clo btn0"><a href="{{url('admin/add_home_choose_image_data')}}/{{$id->id}}">update</a></button></th>
                  </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_home_choose_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
                 ...
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->description}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_home_choose_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                  ...
                  .then((willDelete) => {
                    ...
                    var id = $id;
                          ...
                          $.ajax({
                                ...
                                url:BASE_URL+'/admin/delete_home_choose/'+id,
                                type:'GET',
                                dataType: "json",
