      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
            	...
            	@foreach($education_work_image as $id)
                 ...
                 <tr>
                 	...
                 	<div class="set_width"><img src="/uploads/{{$id->image}}" height="200" width="300" style="padding:15px" ></div>
                  ...
                  <tr>
                  	 ...
                  	 <button class="clo btn0"><a href="{{url('admin/add_education_work_image_data')}}/{{$id->id}}">update</a></button> 
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_education_work_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($education_work as $key=>$ad)
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_education_work_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                  ...
                  .then((willDelete) => {
                    ...
                    var id = $id;
                          ...
                          $.ajax({
                                ...
                                url:BASE_URL+'/admin/delete_education_work/'+id,
                                type:'GET',
                                dataType: "json",
