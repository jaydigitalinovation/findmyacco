...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add How to Work</span></a>
               @else
               <a href=""><span>Update How to Work</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add How to Work</h4>
          @else
            <h4 class="mb-4">Update How to Work</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_home_work_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
