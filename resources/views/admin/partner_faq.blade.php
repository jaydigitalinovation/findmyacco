...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="index.html"><span>Partner FAQ</span></a>
            </li>
         </ul>
      </div>
            ...
            <table class="table table-bordered table-striped text">
            	...
            	@foreach($partner_faq_des as $id)
                 ...
                 <tr>
                  ...
                  <tr>
                  	 <th><button class="clo btn0"><a href="{{url('admin/add_partner_faq_des_data')}}/{{$id->id}}">update</a></button></th>  
                  </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_partner_faq_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
               ...
               @foreach($partner_faq as $key=>$ad)
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                        ...
                        <td>{{$ad->answer}}</td>
                        <td>
                          <a class="icon__1" href="{{url('admin/add_partner_faq_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                  ...
                  .then((willDelete) => {
                    ...
                    var id = $id;
                          ...
                          $.ajax({
                                ...
                                url:BASE_URL+'/admin/delete_partner_faq/'+id,
                                type:'GET',
                                dataType: "json",
