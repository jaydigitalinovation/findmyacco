...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="index.html"><span>Partner Detail</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_partner_detail_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($partner_detail as $key=>$ad)
                 <tbody class="case_studies_{{$ad->id}}">
                    <tr>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_partner_detail_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                  ...
                  .then((willDelete) => {
                    ...
                    var id = $id;
                          ...
                          $.ajax({
                                ...
                                url:BASE_URL+'/admin/delete_partner_detail/'+id,
                                type:'GET',
                                dataType: "json",
