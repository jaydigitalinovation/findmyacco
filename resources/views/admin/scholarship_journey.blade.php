...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Scholarship Banner Detail</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($scholarship_journey as $id)
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                     ...
                     <th><button class="clo btn0"><a href="{{url('admin/add_scholarship_journey_data')}}/{{$id->id}}">update</a></button></th>  
